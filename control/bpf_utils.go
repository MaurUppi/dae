...
// - bpfTuplesKey (struct tuples_key)
// - bpfRoutingResult (struct routing_result)
// - bpfDomainRouting (struct domain_routing)
// - bpfPortRange (struct port_range) - NEW: auto-generated via -type flag
// - bpfMatchSet, bpfPidPname, bpfRedirectEntry, etc.
//
// However, some complex types with nested structs cannot be auto-generated:
// - _bpfTuples (struct tuples) - contains tuples_key
// - _bpfLpmKey (struct lpm_key) - contains bpf_lpm_trie_key
//
// These require manual synchronization. When modifying the corresponding
// C structs in kern/tproxy.c, you MUST also update these Go definitions.
//
